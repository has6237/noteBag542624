<div>
    ...
    <form class="max-w-180 p-5 ml-auto mr-auto mt-10 border border-black bg-teal-100" wire:submit="update">
        @if (session('status'))
        ...
        <button class="mt-5 border border-black p-1 hover:bg-green-500" type="submit">Update</button>
